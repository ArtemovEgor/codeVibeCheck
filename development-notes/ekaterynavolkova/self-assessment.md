...
| ---------------- | ------------------------------------------------------------------------------------------------------------------------ | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| My Components    | Complex Component: Widget Engine (Strategy pattern, виджеты)                                                             | +25   | [Widget engine code](https://github.com/ArtemovEgor/codeVibeCheck/blob/develop/src/services/widget-engine.ts), [Widget engine PR](https://github.com/ArtemovEgor/codeVibeCheck/pull/32)                                                                                                                                                                       |
| My Components    | Rich UI Screen: Dashboard Page (SkillMastery, Resume sector)                                                             | +20   | [Skill Mastery code](https://github.com/ArtemovEgor/codeVibeCheck/tree/develop/src/components/skill-mastery), [Skill Mastery PR](https://github.com/ArtemovEgor/codeVibeCheck/pull/94), [Resume learning](https://github.com/ArtemovEgor/codeVibeCheck/pull/105)                                                                                              |
| My Components    | Rich UI Screen: Library Page                                                                                             | +20   | [Library code](https://github.com/ArtemovEgor/codeVibeCheck/tree/develop/src/pages/library), [Library PR](https://github.com/ArtemovEgor/codeVibeCheck/pull/82), [Library search](https://github.com/ArtemovEgor/codeVibeCheck/pull/84)                                                                                                                       |
| My Components    | Rich UI Screen: Practice Page                                                                                            | +20   | [Practice Page code](https://github.com/ArtemovEgor/codeVibeCheck/tree/develop/src/pages/practice), [Practice Page + Quiz widget PR](https://github.com/ArtemovEgor/codeVibeCheck/pull/41)                                                                                                                                                                    |
| Architecture     | API Layer: WidgetsApi, ProgressApi, mock                                                                                 | +10   | [Widgets API code](https://github.com/ArtemovEgor/codeVibeCheck/blob/develop/src/api/widgets.api.ts), [Widgets API PR](https://github.com/ArtemovEgor/codeVibeCheck/pull/34), [Progress API code](https://github.com/ArtemovEgor/codeVibeCheck/blob/develop/src/api/progress.api.ts), [Progress API PR](https://github.com/ArtemovEgor/codeVibeCheck/pull/70) |
| Architecture     | Design Patterns: Strategy pattern в Widget Engine, Singleton Service в сервисах как LocalizationService, ProgressService | +10   | [Widget engine code](https://github.com/ArtemovEgor/codeVibeCheck/blob/develop/src/services/widget-engine.ts), [Progress Service code](https://github.com/ArtemovEgor/codeVibeCheck/blob/develop/src/services/progress-service.ts)                                                                                                                            |
| UI & Interaction | Theme Switcher: light/dark                                                                                               | +10   | [Theme Switcher code](https://github.com/ArtemovEgor/codeVibeCheck/tree/develop/src/components/layout/theme-switcher), [Theme Switcher in layout PR](https://github.com/ArtemovEgor/codeVibeCheck/pull/20)                                                                                                                                                    |
| UI & Interaction | i18n: локализация EN/RU                                                                                                  | +10   | [Localisation Service code](https://github.com/ArtemovEgor/codeVibeCheck/blob/develop/src/services/localization-service.ts), [Localisation PR](https://github.com/ArtemovEgor/codeVibeCheck/pull/86)                                                                                                                                                          |
| UI & Interaction | Responsive: Адаптация верстки под мобильные устройства (от 320px)                                                        | +5    | [Layout scss code](https://github.com/ArtemovEgor/codeVibeCheck/blob/develop/src/components/layout/app-layout/app-layout.scss), [Layout PR](https://github.com/ArtemovEgor/codeVibeCheck/pull/20)                                                                                                                                                             |
| Quality          | Unit Tests (Basic): vitest, widget-engine.spec, true-false-strategy.spec                                                 | +10   | [Widget tests code](https://github.com/ArtemovEgor/codeVibeCheck/blob/develop/src/services/widget-engine.spec.ts), [code 2](https://github.com/ArtemovEgor/codeVibeCheck/blob/develop/src/components/widgets/true-false/true-false-strategy.spec.ts), [Widget tests](https://github.com/ArtemovEgor/codeVibeCheck/pull/56)                                    |
...
Разработала полный цикл клиентской части (Frontend Core) для системы виджетов: от системного проектирования до реализации UI.
